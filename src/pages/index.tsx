                ...
                <Layout className={'pt-0 md:pt-16 sm:pt-8'}>
                    <div className={'flex items-center justify-between w-full lg:flex-col'}>
                        ...
                        <div className={'w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'}>
                            <AnimatedText className={'!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl'}
                                          text={'Turning Vision Into Reality With Code And Design.'} />
                            <p className={'my-4 text-base font-medium md:text-sm sm:text-xs'}>
                                As a skilled full-stack
                                developer, I am dedicated to turning ideas
                            ...
                            <div className={'flex items-center self-start mt-2 lg:self-center'}>
                                <Link
                                    ...
                                    className={'flex items-center bg-dark text-light p-2.5' +
                                        ...
                                        'hover:border-dark transition-colors duration-500 dark:bg-light dark:text-dark ' +
