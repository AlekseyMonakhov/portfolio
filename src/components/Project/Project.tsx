    ...
    return (
        <article
            ...
            {done ?
                ...
                <div className={'w-full flex-1 cursor-pointer overflow-hidden rounded-lg'}>
                    ...
                    <div
                        ...
                        <h3 className={'text-light text-6xl font-bold selection:bg-red-500 selection:underline'}>In
                            Process</h3>
                    </div>
                </div>
            }
            ...
            <div className={'w-full flex flex-col items-start justify-between mt-4'}>
                <span className={'text-primary font-medium text-2xl dark:text-primaryDark'}>{type}</span>
                <Link href={link} target={'_blank'}
